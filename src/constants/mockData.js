...
// caseCapacity — 正式資料來源：Google Sheets「律師設定」工作表 C 欄，由所長維護

export const MOCK_LAWYERS = [
  { id: 'A', activeCases: 8,  caseCapacity: 10, newCasesThisMonth: 2, plannedCloseThisMonth: 4, closedThisMonth: 3, avgCycleDays: 42, upcomingDeadlines: 2, billingHours: 98,  billingHoursLastMonth: 88,  overdue: { expired: 1, warning: 2 }, caseTypes: [{ type: '民事訴訟', count: 3, avgElapsedDays: 55,  avgDays: 118 }, { type: '家事案件', count: 2, avgElapsedDays: 38,  avgDays: 75  }, { type: '財富傳承', count: 2, avgElapsedDays: 28,  avgDays: 52  }, { type: '行政訴訟', count: 1, avgElapsedDays: 95,  avgDays: 188 }] },
  { id: 'B', activeCases: 6,  caseCapacity: 10, newCasesThisMonth: 1, plannedCloseThisMonth: 3, closedThisMonth: 2, avgCycleDays: 38, upcomingDeadlines: 1, billingHours: 110, billingHoursLastMonth: 120, overdue: { expired: 2, warning: 1 }, caseTypes: [{ type: '智慧財產', count: 3, avgElapsedDays: 82,  avgDays: 162 }, { type: '商事相關', count: 2, avgElapsedDays: 32,  avgDays: 68  }, { type: '勞資糾紛', count: 1, avgElapsedDays: 48,  avgDays: 104 }] },
  { id: 'C', activeCases: 5,  caseCapacity: 10, newCasesThisMonth: 3, plannedCloseThisMonth: 5, closedThisMonth: 4, avgCycleDays: 30, upcomingDeadlines: 0, billingHours: 85,  billingHoursLastMonth: 80,  overdue: { expired: 0, warning: 1 }, caseTypes: [{ type: '商事相關', count: 3, avgElapsedDays: 28,  avgDays: 65  }, { type: '民事訴訟', count: 2, avgElapsedDays: 52,  avgDays: 110 }] },
  { id: 'D', activeCases: 7,  caseCapacity: 8,  newCasesThisMonth: 1, plannedCloseThisMonth: 2, closedThisMonth: 1, avgCycleDays: 55, upcomingDeadlines: 1, billingHours: 105, billingHoursLastMonth: 98,  overdue: { expired: 1, warning: 2 }, caseTypes: [{ type: '刑事訴訟', count: 4, avgElapsedDays: 142, avgDays: 225 }, { type: '民事訴訟', count: 2, avgElapsedDays: 65,  avgDays: 132 }, { type: '行政訴訟', count: 1, avgElapsedDays: 98,  avgDays: 201 }] },
  { id: 'E', activeCases: 4,  caseCapacity: 10, newCasesThisMonth: 2, plannedCloseThisMonth: 3, closedThisMonth: 2, avgCycleDays: 28, upcomingDeadlines: 0, billingHours: 72,  billingHoursLastMonth: 75,  overdue: { expired: 0, warning: 0 }, caseTypes: [{ type: '家事案件', count: 2, avgElapsedDays: 42,  avgDays: 88  }, { type: '財富傳承', count: 2, avgElapsedDays: 18,  avgDays: 42  }] },
  { id: 'F', activeCases: 6,  caseCapacity: 10, newCasesThisMonth: 1, plannedCloseThisMonth: 3, closedThisMonth: 2, avgCycleDays: 50, upcomingDeadlines: 3, billingHours: 125, billingHoursLastMonth: 115, overdue: { expired: 1, warning: 3 }, caseTypes: [{ type: '勞資糾紛', count: 3, avgElapsedDays: 55,  avgDays: 98  }, { type: '民事訴訟', count: 2, avgElapsedDays: 68,  avgDays: 128 }, { type: '行政訴訟', count: 1, avgElapsedDays: 112, avgDays: 205 }] },
  { id: 'G', activeCases: 3,  caseCapacity: 10, newCasesThisMonth: 1, plannedCloseThisMonth: 2, closedThisMonth: 1, avgCycleDays: 35, upcomingDeadlines: 0, billingHours: 58,  billingHoursLastMonth: 62,  overdue: { expired: 0, warning: 0 }, caseTypes: [{ type: '智慧財產', count: 2, avgElapsedDays: 72,  avgDays: 148 }, { type: '商事相關', count: 1, avgElapsedDays: 35,  avgDays: 78  }] },
  { id: 'H', activeCases: 5,  caseCapacity: 10, newCasesThisMonth: 2, plannedCloseThisMonth: 4, closedThisMonth: 3, avgCycleDays: 44, upcomingDeadlines: 1, billingHours: 90,  billingHoursLastMonth: 85,  overdue: { expired: 0, warning: 1 }, caseTypes: [{ type: '財富傳承', count: 3, avgElapsedDays: 22,  avgDays: 45  }, { type: '家事案件', count: 2, avgElapsedDays: 45,  avgDays: 84  }] },
  { id: 'I', activeCases: 4,  caseCapacity: 10, newCasesThisMonth: 1, plannedCloseThisMonth: 3, closedThisMonth: 2, avgCycleDays: 32, upcomingDeadlines: 0, billingHours: 78,  billingHoursLastMonth: 78,  overdue: { expired: 0, warning: 0 }, caseTypes: [{ type: '民事訴訟', count: 2, avgElapsedDays: 58,  avgDays: 120 }, { type: '商事相關', count: 2, avgElapsedDays: 38,  avgDays: 74  }] },
  { id: 'J', activeCases: 6,  caseCapacity: 10, newCasesThisMonth: 2, plannedCloseThisMonth: 3, closedThisMonth: 2, avgCycleDays: 48, upcomingDeadlines: 2, billingHours: 108, billingHoursLastMonth: 100, overdue: { expired: 1, warning: 2 }, caseTypes: [{ type: '刑事訴訟', count: 3, avgElapsedDays: 115, avgDays: 198 }, { type: '行政訴訟', count: 2, avgElapsedDays: 108, avgDays: 192 }, { type: '勞資糾紛', count: 1, avgElapsedDays: 62,  avgDays: 102 }] },
  { id: 'K', activeCases: 5,  caseCapacity: 10, newCasesThisMonth: 2, plannedCloseThisMonth: 4, closedThisMonth: 3, avgCycleDays: 36, upcomingDeadlines: 1, billingHours: 88,  billingHoursLastMonth: 92,  overdue: { expired: 0, warning: 1 }, caseTypes: [{ type: '商事相關', count: 3, avgElapsedDays: 42,  avgDays: 70  }, { type: '智慧財產', count: 2, avgElapsedDays: 88,  avgDays: 158 }] },
  { id: 'L', activeCases: 3,  caseCapacity: 10, newCasesThisMonth: 1, plannedCloseThisMonth: 2, closedThisMonth: 1, avgCycleDays: 29, upcomingDeadlines: 0, billingHours: 55,  billingHoursLastMonth: 50,  overdue: { expired: 0, warning: 0 }, caseTypes: [{ type: '家事案件', count: 2, avgElapsedDays: 35,  avgDays: 78  }, { type: '民事訴訟', count: 1, avgElapsedDays: 52,  avgDays: 115 }] },
]
